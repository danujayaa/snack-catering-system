...
class EditAddress extends StatelessWidget {
  ...
  EditAddress({super.key, required this.address}) {
    ...
    penerimaController.text = address.penerima;
    alamatController.text = address.alamat;
    kecamatanController.text = address.kecamatan;
    kabupatenController.text = address.kabupaten;
    kodeposController.text = address.kodepos;
    ...
    return ElevatedButton(
      onPressed: () {
        if (_validateForm()) {
          ...
          fetchDataAddress.updateAddress(updatedAddress);
          Get.back();
        }
      },
